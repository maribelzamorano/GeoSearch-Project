...
<tdl:var-set name="actionURL">/media/media-list</tdl:var-set>
	...
	<table width="100%" class="topdev_hitlist" cellpadding="0" cellspacing="1">
		...
		<tr>
			...
			<s:iterator value="headingList" status="rowstatus">
				<th align="left">
					<nobr><s:property value="value"/></nobr>
				</th>
			</s:iterator>
		</tr>
		<s:iterator value="entryList" status="rowstatus">
					...
					<td >
						<c:if test="${!modified}">
							<c:if test="${deleted=='1'}"><strike></c:if>
								<nobr><s:property value="decode"/></nobr>
							<c:if test="${deleted=='1'}"></strike></c:if>
						</c:if>
					</td>
				</s:iterator>
			...
			<td><s:property value="GesamtsummeTeilzeit"/>
			</td>
			<td><s:property value="GesamtsummeVollzeit"/>
			</td>
			<td><s:property value="Gesamtsumme"/>
			</td>
			</tr>
	</table>
</s:push>
