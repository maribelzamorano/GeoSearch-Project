...
<c:set var="lastMediResultList" scope="session">result_newest</c:set>
		...
		<tr>
			<td align="left">
				<s:if test="searchObj.rowsTotal > 0">
					<input type="button"	class="topdev_button_print" value="Drucken"	 onclick="window.open('<tv2:url>/medium_result_newest/print.action</tv2:url>')"/>
				</s:if>
			</td>
			<td align="center">
