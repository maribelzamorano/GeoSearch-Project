...
<tr>
	<td class="space_left" colspan="2">
		<s:if test="gepa_rolle=='10'">
			<div class="schoolnumber"><s:property value="cc_schulart_dien_nr"/>  </div>
		</s:if>
...
<tr>
				...
				<s:if test="schooltractList.entryList.size > 0">
					<tr>
						<td class="topdev_title_gray space_top" colspan="2">
							<tui:msg key="schulteile" type="label"/>
						</td>
					</tr>
	...
	<s:if test="leitbild!=''">
		<tr>
			<td class="topdev_title_gray space_top" colspan="2">
				<tui:msg key="leitbild" type="label"/>				
			</td>
		</tr>
		<tr>
			<td class="space_left block" colspan="2">
				<tui:reviser styling="true">
					<tui:breaker><s:property value="leitbild"/></tui:breaker>
				</tui:reviser>
			</td>
		</tr>
	</s:if>
...
<tr height="50px" valign="bottom"> 
	...
	<td class="button" align="right">
		<input type="button"	class="topdev_button_print" value="Drucken"	 onclick="window.open('<tui:url>/businesspartner/print.action</tui:url>')"/>
	</td>
</tr>
<s:if test="gepa_rolle=='10'">
	<tr>
