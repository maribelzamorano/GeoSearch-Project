...
<tdl:var-set name="portletBackUrl">personal_resources?tspi=<s:property value="tspi"/></tdl:var-set>
...
<s:push value="mainObject">
	...
	<tui:tabBox tabCount="1" activeTabId="1" name="tabbox1">
		<tui:tab id="1" active="true">
			<s:action name="personal-list_edit" executeResult="true">
	...
	<tui:buttonbar>
		<tui:button type="save">AjaxUtil.update('<tui:url>/personal_resources/save.action</tui:url>','${ns}_info');</tui:button>
