...
<s:if test="%{contributerSortList}">

<table class="topdev_view" width="100%" cellspacing="0">
	<s:iterator value="contributerSortList">
		<tr>
			<td class="topdev_title_gray_first" colspan="3"><s:property value="decode"/></td>
		</tr>
		<tr>
			<td colspan="3">
				<s:action name="contributer-list_view_filter" executeResult="true">
	...
	<s:if test="ContributerList.entryList.size>0" >
		<tr height="50px" valign="bottom"> 
			<td colspan="2"></td>		
			<td class="button" align="right">
				<input type="button"	class="topdev_button_print" value="Drucken"	 onclick="window.open('<tui:url>/contributer/print.action</tui:url>')"/>
			</td>
		</tr>
		<tr>
			<td colspan="2">
	...
	<s:if test="ContributerList.entryList.size==0">
		<tr>
			<td colspan="3"><tui:msg key="keine_daten" type="label"/>
			</td>
		</tr>
	</s:if>
		<tr>
