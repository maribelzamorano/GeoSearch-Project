...
<tdl:var-set name="actionURL">/school_life/tradition-detail</tdl:var-set>
	...
	<tr class="row_odd">
		<td colspan="2" class="first">
			<s:if test="deleted == 1"><strike></s:if>
				<b><s:property value="trad_bezeichnung"/></b>
			<s:if test="deleted == 1"></strike></s:if>
		</td>							
	</tr>
	<s:if test="deleted != 1">
		<tr >
			<td class="left space_top" colspan="2">
			 <tui:breaker><s:property value="trad_beschreibung"/></tui:breaker>
			</td>
		</tr>	
	<s:if test="faecher !=''">
			<tr >
