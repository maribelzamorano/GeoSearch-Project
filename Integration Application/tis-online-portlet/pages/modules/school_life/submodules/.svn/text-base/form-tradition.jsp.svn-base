...
<s:push value="entry">
<tdl:var-set name="form_forwardUrl"><tui:url>/school_life/tradition-list_edit.action</tui:url></tdl:var-set>
...
<tr>
	...
	<tui:textfield name="trad_bezeichnung" obligation="true" maxlength="255"><s:property value="trad_bezeichnung"/></tui:textfield>	 			
</tr>
<tr>
	<tui:fieldlabel>Beschreibung:</tui:fieldlabel>	
	<tui:textarea name="trad_beschreibung" obligation="true" maxlength="1000"><s:property value="trad_beschreibung"/></tui:textarea>			
</tr>
<tr>
...
<tr>
	<td colspan="2">
		...
		<%--<tdl:var-set name="linktext">+ Neue Klassenstufe(n)</tdl:var-set> --%>
...
<tr>
	<td colspan="2">
		...
		<%--<tdl:var-set name="linktext">+ Neues Fach/ Neue Faechergruppe</tdl:var-set>--%>
...
<tr>
	<td colspan="2" class="buttonbar">
		<tui:button type="save" scope="tab">
			var url = '<tui:url>/school_life/tradition-detail_save.action</tui:url>' + '&' + Form.serialize(document.getElementById('<s:property value="ajaxId"/>_form'));
			TopdevUtil.updateTab('<tdl:var name="ns"/>','<tdl:var name="ajaxId"/>',url);
		</tui:button>
		<tui:button type="abort">TopdevUtil.updateTab('<tdl:var name="ns"/>','<tdl:var name="ajaxId"/>','<tui:url>/school_life/tradition-list_edit.action</tui:url>')</tui:button>
	</td>
</tr>
</table>
