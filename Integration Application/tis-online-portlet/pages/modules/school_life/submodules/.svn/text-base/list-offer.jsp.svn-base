...
<tdl:var-set name="actionURL">/school_life/offer-detail</tdl:var-set>
	...
	<tr class="row_odd">
		<td colspan="2" class="first">
			<s:if test="deleted == 1"><strike></s:if>
				<b><s:property value="foan_bezeichnung"/></b>
			<s:if test="deleted == 1"></strike></s:if>
		</td>							
	</tr>
	<s:if test="deleted != 1">
		<tr >
			...
			<tui:breaker><s:property value="foan_beschreibung"/></tui:breaker>
			</td>
		</tr>	
	<s:if test="faecher !=''">
		<tr >
