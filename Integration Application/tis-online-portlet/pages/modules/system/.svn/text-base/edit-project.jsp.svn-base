...
<s:push value="mainObject">
	...
	<tui:tabBox tabCount="1" activeTabId="1" name="project_tabbox">
	...
	<tui:buttonbar>
		<tui:button type="save">AjaxUtil.update('<tui:url>/system/project-save.action</tui:url>','${ns}_info');</tui:button>
