							...
							<fo:table-row>
								<fo:table-cell padding-top="2pt" padding-left="2pt"  table-layout="fixed" border="0.0pt #000000 solid">
									<fo:block font-weight="bold" font-size="10pt" text-decoration="underline">
										<xsl:value-of select="LABEL-MAND_BESCHREIBUNG"/>
									</fo:block>
								</fo:table-cell>
								<fo:table-cell padding-top="2pt" padding-left="2pt"  table-layout="fixed" border="0.0pt #000000 solid">
									<fo:block font-weight="bold" font-size="10pt" text-decoration="underline">
										<xsl:value-of select="LABEL-VESG_NR"/>
									</fo:block>
								</fo:table-cell>
								<fo:table-cell padding-top="2pt" padding-left="2pt"  table-layout="fixed" border="0.0pt #000000 solid">
									<fo:block font-weight="bold" font-size="10pt" text-decoration="underline">
										<xsl:value-of select="LABEL-VESG_TERMIN"/>
									</fo:block>
								</fo:table-cell>
								<fo:table-cell padding-top="2pt" padding-left="2pt"  table-layout="fixed" border="0.0pt #000000 solid">
									<fo:block font-weight="bold" font-size="10pt" text-decoration="underline">
										<xsl:value-of select="LABEL-VESG_ORT"/>
									</fo:block>
								</fo:table-cell>								
								<fo:table-cell padding-top="2pt" padding-left="2pt"  table-layout="fixed" border="0.0pt #000000 solid">
									<fo:block font-weight="bold" font-size="10pt" text-decoration="underline">
										<xsl:value-of select="LABEL-VESG_THEMA_ANZEIGE"/>
									</fo:block>
								</fo:table-cell>
								<fo:table-cell padding-top="2pt" padding-left="5pt"  table-layout="fixed" border="0.0pt #000000 solid">
									<fo:block font-weight="bold" font-size="10pt" text-decoration="underline">
										<xsl:value-of select="LABEL-VESG_ANMELDEN_LABEL"/>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
						</fo:table-body>
...
<xsl:template match="data">
	<fo:table-row>
		...
		<fo:table-cell padding-top="2pt" padding-left="5pt"  table-layout="fixed" border="0.0pt #000000 solid">
			<fo:block language="en" hyphenate="true" font-size="10pt" font-weight="normal">
				<xsl:value-of select="VESG_ANMELDEN_LABEL"/>
			</fo:block>
		</fo:table-cell>																
	</fo:table-row>
</xsl:template>
