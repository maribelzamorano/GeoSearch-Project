	   					...
	   					<fo:table-row>
							<fo:table-cell border-left="0.1pt #000000 solid" padding-left="10pt">						
		         				<fo:block font-size="8pt"  font-family="Helvetica">   
								    Das Staatliche Schulamt Cottbus gehört zum Geschäftsbereich des Ministeriums für Bildung, Jugend 
								    und Sport und ist regional zuständig für die Landkreise Spree-Neiße, Oberspreewald-Lausitz, Elbe-Elster und
												...
												<fo:table-row>
														<fo:table-cell number-columns-spanned="2" >	
															<fo:block language="en" hyphenate="true" hyphenation-remain-character-count="5" font-size="8pt" text-decoration="underline" font-family="Helvetica">         					
																hannelore.roigk@schulaemter.brandenburg.de
															</fo:block>
														</fo:table-cell>
													</fo:table-row>
											</fo:table-body>
