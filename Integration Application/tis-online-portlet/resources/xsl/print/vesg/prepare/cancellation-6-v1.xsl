	   					...
	   					<fo:table-row>
							<fo:table-cell border-left="0.1pt #000000 solid" padding-left="10pt">						
		         				<fo:block font-size="8pt"  font-family="Helvetica">   
								    Das Staatliche Schulamt Eberswalde gehört zum Geschäftsbereich des Ministeriums für Bildung, Jugend
									und Sport und ist regional zuständig für die Landkreise Uckermark und Barnim.
							...
							<fo:table-row>
								<fo:table-cell >
								 ...
								 <fo:table table-layout="fixed">   
									...
									<fo:block font-size="8pt" font-family="Helvetica" >         					
									Staatliches Schulamt Eberswalde&#160;&#160;|&#160;&#160;Heegermühler Straße 64&#160;&#160;|&#160;&#160;16225 Eberswalde
									</fo:block>
									...
									<fo:table table-layout="fixed">     							
											...
											<fo:table-body>
												...
												<fo:table-row>				
													...
													<fo:table-row>
														<fo:table-cell number-columns-spanned="2" >	
															<fo:block language="en" hyphenate="true" hyphenation-remain-character-count="5" font-size="7pt" font-family="Helvetica">         					
																sigrid.moldenhauer@schulaemter.brandenburg.de
															</fo:block>
															<fo:block language="en" hyphenate="true" hyphenation-remain-character-count="5" font-size="8pt" font-family="Helvetica">         					
																Bus 861, 862 (Haltestelle Kranbau)
															</fo:block>
														</fo:table-cell>
													</fo:table-row>
											</fo:table-body>
					...
					<fo:table-row>
							<fo:table-cell >						
		         				<fo:block font-size="12pt" font-family="Helvetica" text-align="right">         					
									Eberswalde, <xsl:value-of select="Datum"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
						...
						<fo:table-row>
							<fo:table-cell>						
		         				<fo:block font-size="12pt" font-family="Helvetica">         					
									Bezüglich eines neuen Termins oder ähnlicher Angebote informieren Sie sich bitte im Veranstaltungskatalog im Internet (FortbildungsNetz).
								</fo:block>
							</fo:table-cell>
						</fo:table-row>	
