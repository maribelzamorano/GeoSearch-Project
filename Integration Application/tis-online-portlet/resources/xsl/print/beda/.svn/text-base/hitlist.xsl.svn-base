		...
		<fo:page-sequence master-reference="contents" initial-page-number="1">
			<fo:static-content flow-name="xsl-region-before">
				<fo:block font-family="Helvetica" font-size="10pt" text-align="center"  padding-bottom="10pt">
					<fo:table table-layout="fixed" border="0.1pt black solid" font-size="8pt">
						...
						<fo:table-body>
							<fo:table-row>
								...
								<fo:table-cell>
									<fo:block  border-left="0.1pt black solid"  border-right="0.1pt black solid"  padding-top="3pt" padding-bottom="3pt">
										<fo:block text-align="center" font-size="10pt" font-weight="bold">Bedarfsmeldungen</fo:block>
...
<xsl:template match="beda_hitlist">
	<fo:table-row>
		...
		<fo:table-cell padding-bottom="5pt">
			<fo:block text-align="left">
				<xsl:value-of select="Gueltigkeitsbereich"/>
			</fo:block>
		</fo:table-cell>
		<fo:table-cell padding-bottom="5pt">
		   	<fo:block text-align="left">
				<xsl:value-of select="Fortbildungsart"/>
			</fo:block>
		</fo:table-cell>
		<fo:table-cell padding-bottom="5pt">
		   	<fo:block text-align="left">
		...
		<fo:table-cell padding-bottom="5pt">
		   	<fo:block text-align="left">
				<xsl:value-of select="erstellt_von"/>
			</fo:block>
		</fo:table-cell>		
    </fo:table-row>
</xsl:template>
