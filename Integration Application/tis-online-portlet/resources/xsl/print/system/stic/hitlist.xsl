			...
			<fo:flow flow-name="xsl-region-body" >
				<fo:block>
					<fo:table>
						...
						<fo:table-body>
							<fo:table-row>
								<fo:table-cell padding-top="2pt" padding-left="2pt"  border="0.0pt #000000 solid">
						...
						<xsl:apply-templates select="stic"/>
					</fo:table>
				</fo:block>	
			</fo:flow>			
