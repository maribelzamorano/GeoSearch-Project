...
public class ProjectListAction extends DetailAction
{
	...
	public void init(String aktion) throws Exception
	{
		...
		if(getMainObject().getProjectList()==null || getMainObject().getProjectList().getEntryList().size()<1)
			getMainObject().loadDataProject();
		complexList = getMainObject().getProjectList();
	}
