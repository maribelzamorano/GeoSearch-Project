package com.topdev.tsp.action.modules.medium.detail.overview.submodules.templates;
...
public class KontrolliertesschlagwortListAction extends AjaxImpl implements Ajax
{
	...
	{
		results = com.topdev.service.mediumkonschlagwort.Client.getAll(getUserName());
		return "success";
	}
