package com.topdev.tsp.model.list.modules.contributer;
...
public class Contributer extends ComplexEntryList implements EntryList
{
	...
	public Contributer()								{				}
	public Contributer(String id)					{ setId(id);	}
	public Contributer(HashMap<String, String> map)	{ setData(map);	}
	...
	public void setData(HashMap<String, String> map)
	{
		...
		getEntries().add(new SimpleEntry("erreichbarkeit",	getErreichbarkeit(),							"encryptedTextfield"));
	}
