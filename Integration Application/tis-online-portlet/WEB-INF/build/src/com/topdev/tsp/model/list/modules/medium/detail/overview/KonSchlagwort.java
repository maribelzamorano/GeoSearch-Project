...
public class KonSchlagwort extends ComplexEntryList
{
    ...
    public KonSchlagwort()							{				}
	public KonSchlagwort(String id)					{ setId(id);	}
	public KonSchlagwort(HashMap<String, String> map)	{ setData(map);	}
