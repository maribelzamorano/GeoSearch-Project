...
public class DropdownFilteredContentAction extends BasicActionSupport
{
	...
	public String execute() throws Exception
	{
		...
		List <String> exclude = getExclusionTokens();
		...
		else
		{
			...
			try
			{
				...
				if(rs!=null) while(rs.next())
					if (!exclude.contains(rs.getString("CODE")))
						elements.add(
							new DropdownElement(
								rs.getString("CODE"),
								rs.getString("DECODE")));
	...
	{
		DropdownFilteredContentAction.lists = lists;
	}
	...
	{
		DropdownFilteredContentAction.times = times;
	}
	...
	public List<String> getExclusionTokens()
	{
		if (exclusion != null)
		{
